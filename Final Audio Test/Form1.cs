...
namespace Final_Audio_Test
{
    public partial class Form1 : Form
    {
        ...
        public byte[] value = new byte[] { 0, 0, 0 };  // 3 values used for read write
        public int i = 0;
        ...
        public UInt32[] PortOffsets = new UInt32[5] { 0x0, 0x4, 0x8, 0x12, 0x16 }; // offsets for 5 max groups
        ...
        {
            if (DUT.APautoShutdown == 1) { if (APx != null) { APx.Exit(); } }
       ...
       //     createLogFiles();       
            ...
            if (DUT.Debug == 0) { DebugMode.Text = null; }
        ...
        {
            if (productButton0.Checked) { return 0; }
            else if (productButton1.Checked) { return 1; }
            else if (productButton2.Checked) { return 2; }
            else if (productButton3.Checked) { return 3; }
            else if (productButton4.Checked) { return 4; }
            else if (productButton5.Checked) { return 5; }
            else if (productButton6.Checked) { return 6; }
            else if (productButton7.Checked) { return 7; }
            else if (productButton8.Checked) { return 8; }
            else if (productButton9.Checked) { return 9; }
            else if (productButton10.Checked) { return 10; }
            else if (productButton11.Checked) { return 11; }
            else if (productButton12.Checked) { return 12; }
            else if (productButton13.Checked) { return 13; }
            else if (productButton14.Checked) { return 14; }
            else if (productButton15.Checked) { return 15; }
            else if (productButton16.Checked) { return 16; }
            else if (productButton17.Checked) { return 17; }
            else if (productButton18.Checked) { return 18; }
            else if (productButton19.Checked) { return 19; }
            else if (productButton20.Checked) { return 20; }
            else if (productButton21.Checked) { return 21; }
            else if (productButton22.Checked) { return 22; }
            else { return -1; }
        }

        private int getModelIndex()
        {
            if (modelButton0.Checked) { return 0; }
            else if (modelButton1.Checked) { return 1; }
            else if (modelButton2.Checked) { return 2; }
            else if (modelButton3.Checked) { return 3; }
            else if (modelButton4.Checked) { return 4; }
            else if (modelButton5.Checked) { return 5; }
            else { return -1; }
        }
        ...
        void setupProductModel(int productIndex, int modelIndex)
        {
            ...
            if (productIndex == 0)
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true;
                modelButton0.Text = "100X"; modelButton1.Text = "100X-NAVY V01"; modelButton2.Text = "100X-NAVY";

                if (modelIndex > 2) { modelButton0.Checked = true; DUT.productModel = "100X"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true;
                modelButton0.Text = "300Xi"; modelButton1.Text = "300X-RA"; modelButton2.Text = "300XRA-260W";

                if (modelIndex > 2) { modelButton0.Checked = true; DUT.productModel = "300X"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true;
                modelButton0.Text = "450XL"; modelButton1.Text = "450XL Extended Test"; modelButton2.Text = "450XL-RA";

                if (modelIndex > 2) { modelButton0.Checked = true; DUT.productModel = "450XL"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true;
                modelButton0.Text = "500X"; modelButton1.Text = "500XRE";

                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "500X"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true;
                modelButton0.Text = "20' Audio Cable"; modelButton1.Text = "30' Audio Cable"; modelButton2.Text = "100' Audio Cable";

                if (modelIndex > 2) { modelButton0.Checked = true; DUT.productModel = "1000X-20FT"; }
            ...
            else if (productIndex == 8)
            {
                ...
                if (modelIndex > 2) { modelButton0.Checked = true; DUT.productModel = "1000XVB-20FT"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true;
                modelButton0.Text = "35' Audio Cable"; modelButton1.Text = "66' Audio Cable"; modelButton2.Text = "100' Audio Cable";

                if (modelIndex > 2) { modelButton0.Checked = true; DUT.productModel = "1950XL-35FT"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true;
                modelButton0.Text = "Standard Drivers"; modelButton1.Text = "Enhanced Drivers";

                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "360X Manifold"; }
            ...
            else if (productIndex == 11)
            {
                ...
                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "DS60-X"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true;
                modelButton3.Visible = true; modelButton4.Visible = true;
                modelButton0.Text = "DS60-70V-60W"; modelButton1.Text = "DS60-100V-60W"; modelButton2.Text = "DS60-25V-80W";
                modelButton3.Text = "DS60-70V-80W"; modelButton4.Text = "DS60-100V-80W";

                DUT.ExtAmplifier = 1;

                if (modelIndex > 4) { modelButton0.Checked = true; DUT.productModel = "DS60-70V-60W"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true;
                modelButton0.Text = "DS60-70V-160W"; modelButton1.Text = "DS60-100V-160W";

                DUT.ExtAmplifier = 1;

                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "DS60-70V-160W"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true;
                modelButton0.Text = "DS60-X"; modelButton1.Text = "DS60-XL";
         ...
         //       if (DUT.EngTestRoomSetup == 1) { modelButton0.Enabled = modelButton2.Enabled = false; }
           //     else { modelButton1.Enabled = false; }
                ...
                modelButton0.Text = "SS100"; modelButton1.Text = "SS300"; modelButton2.Text = "SS400";

                DUT.ExtAmplifier = 1;

                if (modelIndex > 2) { modelButton0.Checked = true; DUT.productModel = "SS100"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true;
                modelButton0.Text = "SS-X120"; modelButton1.Text = "SS-X60";

                DUT.ExtAmplifier = 1;

                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "SSX"; }
            ...
            else if (productIndex == 17)
            {
                ...
                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "SSX wo Trans"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true; modelButton3.Visible = true;
                modelButton0.Enabled = true; modelButton1.Enabled = true; modelButton2.Enabled = true; modelButton3.Enabled = true;
                modelButton0.Text = "500RX"; modelButton1.Text = "950RXL"; modelButton2.Text = "1000RX"; modelButton3.Text = "950NXT";

                if (modelIndex > 3) { modelButton0.Checked = true; DUT.productModel = "500RX"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true; modelButton2.Visible = true; modelButton3.Visible = true; modelButton4.Visible = true; modelButton5.Visible = true;
                modelButton0.Text = "1-ST 25V-60W"; modelButton1.Text = "1-ST 100V-60W"; modelButton2.Text = "2-ST 25V-60W";
                modelButton3.Text = "2-ST 100V-120W"; modelButton4.Text = "2-ST 70V-60W"; modelButton5.Text = "4-ST 100V-240W";

                DUT.ExtAmplifier = 1;

                if (modelIndex > 5) { modelButton0.Checked = true; DUT.productModel = "360Xm 1-ST 25V-60W"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true;
                modelButton0.Text = "1-ST wo Trans"; modelButton1.Text = "2-ST wo Trans";

                DUT.ExtAmplifier = 1;

                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "360Xm 1-ST wo Trans"; }
            ...
            {
                modelButton0.Visible = true; modelButton1.Visible = true;
                modelButton0.Text = "360XL-MID 1-ST"; modelButton1.Text = "360XL-MID 2-ST";

                DUT.ExtAmplifier = 1;

                if (modelIndex > 1) { modelButton0.Checked = true; DUT.productModel = "360X-MID 1-ST"; }
        ...
        {          
            ...
            if (DUT.autoShutdown == 1) { shutdownTimer.Start(); }
            ...
            if (DUT.Debug == 0) { DebugMode.Text = null; }
            else { DebugMode.Text = "Debug Mode Active"; }
        ...
        {
            remarkBox.Clear(); remarkBox1.Clear(); remarkBox2.Clear(); remarkBox3.Clear(); remarkBox4.Clear(); remarkBox5.Clear();
            remarkBox6.Clear(); remarkBox7.Clear(); remarkBox8.Clear(); remarkBox9.Clear(); remarkBox10.Clear(); remarkBox11.Clear();
            remarkBox12.Clear(); remarkBox13.Clear(); remarkBox14.Clear(); remarkBox15.Clear(); remarkBox16.Clear(); remarkBox17.Clear(); remarkBox18.Clear();
        }

        void resetSampleInfo()
        {
            WO_No.Text = null;
            SN_Box1.Text = SN_Box2.Text = SN_Box3.Text = SN_Box4.Text = SN_Box5.Text = null; SN_Box6.Text = SN_Box7.Text = null;
        ...
        {
            reportAudioResult0.Text = null; reportAudioResult1.Text = null; reportAudioResult2.Text = null;
            reportAudioResult3.Text = null; reportAudioResult4.Text = null; reportAudioResult5.Text = null; reportAudioResult6.Text = null;
            ...
            {
                reportAudioResult0.Text = "  HIGH Power Output"; reportAudioResult1.Text = "  MID Power Output"; reportAudioResult2.Text = "  LOW Power Output";
            ...
            {
                reportAudioResult0.Text = "  HIGH Power Output (TOP)"; reportAudioResult1.Text = "  MID Power Output (TOP)"; reportAudioResult2.Text = "  LOW Power Output (TOP)";
                reportAudioResult3.Text = "  HIGH Power Output (BOT)"; reportAudioResult4.Text = "  MID Power Output (BOT)"; reportAudioResult5.Text = "  LOW Power Output (BOT)";
            ...
            {
                reportAudioResult0.Text = "  Frequency Sweep"; reportAudioResult1.Text = "  Maximum SPL"; reportAudioResult3.Text = "  Maximum Noise Level Output";
                reportPassFail0.Text = reportPassFail1.Text = reportPassFail3.Text = "N/T";

                if (DUT.productModel != "950NXT") { reportAudioResult2.Text = "  Cooling Fans Function"; reportPassFail2.Text = reportPassFail3.Text = "N/T"; }

                
            }
            else if (DUT.productModel == "SS400")
            {
                reportAudioResult0.Text = "  Output Sensitivity/Max SPL"; reportAudioResult1.Text = "  Accelerometer Output";
            ...
            {
                reportAudioResult0.Text = "  Output Sensitivity"; reportAudioResult1.Text = "  Maximum SPL";

                reportPassFail0.Text = reportPassFail1.Text = "N/T";
            }
            else if ((DUT.productModel == "100X") || (DUT.productModel == "100X-NAVY-V1") || (DUT.productModel == "1000X2U"))
            {
                reportAudioResult0.Text = "  MP3 Input Sensitivity / Maximum SPL"; reportAudioResult1.Text = "  Volume Control Function";
            ...
            {
                reportAudioResult0.Text = "  MP3-2 Input Sensitivity / Maximum SPL"; reportAudioResult1.Text = "  Volume Control Function";
                reportAudioResult2.Text = "  MIC Input Sensitivity"; reportAudioResult3.Text = "  Audio Effect Controls"; reportAudioResult4.Text = "  MP3-1 Input Sensitivity";
                reportAudioResult5.Text = "  Maximum Noise level output"; reportAudioResult6.Text = "  IPOD Input Sensitivity / Maximum SPL";
            ...
            {
                reportAudioResult0.Text = "  MP3 Input Sensitivity / Maximum SPL"; reportAudioResult1.Text = "  Volume Control Function";
                reportAudioResult2.Text = "  MUTE Function"; reportAudioResult3.Text = "  Maximum Noise level output";

                reportPassFail0.Text = reportPassFail1.Text = reportPassFail2.Text = reportPassFail3.Text = "N/T";
            }
            else if (productButton22.Checked)  //360X-MIDs
            {
                reportAudioResult0.Text = "  Sensitivity"; reportAudioResult1.Text = "   Maximum SPL";
            ...
            else
            {
                ...
                {
                    reportAudioResult5.Text = "  Limited Switch & AUX Cable"; reportAudioResult6.Text = "  Self Test Function";
                    reportPassFail5.Text = reportPassFail6.Text = reportPassFail2.Text = "N/T";
                }
                reportAudioResult0.Text = "  MP3 Input Sensitivity / Maximum SPL"; reportAudioResult1.Text = "  Volume Control Function"; reportAudioResult2.Text = "  MIC Input Sensitivity";
                reportAudioResult3.Text = "  Audio Effect Controls"; reportAudioResult4.Text = "  Maximum Noise level output";
        ...
        {
            testSelButton0.Visible = false; testSelButton1.Visible = false; testSelButton2.Visible = false; testSelButton3.Visible = false; testSelButton4.Visible = false;
            testSelButton5.Visible = false; testSelButton6.Visible = false; testSelButton7.Visible = false; testSelButton8.Visible = false; testSelButton9.Visible = false;
            ...
            if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction0"); }

            if ((DUT.productModel == "100X") || (DUT.productModel == "100X-NAVY-V1"))
            {
                testSelButton0.Visible = true; testSelButton1.Visible = true; testSelButton2.Visible = true; testSelButton6.Visible = true;
                ...
                testResult0.ForeColor = Color.LightGray; testResult0.ForeColor = Color.LightGray; testResult0.Text = "NT";
                testResult1.ForeColor = Color.LightGray; testResult1.ForeColor = Color.LightGray; testResult1.Text = "NT";
                testResult2.ForeColor = Color.LightGray; testResult2.ForeColor = Color.LightGray; testResult2.Text = "NT";
                testResult6.ForeColor = Color.LightGray; testResult8.ForeColor = Color.LightGray; testResult6.Text = "NT";

            }
            else if (DUT.productModel == "100X-NAVY")
            {
                testSelButton0.Visible = true; testSelButton1.Visible = true; testSelButton2.Visible = true; testSelButton3.Visible = true;
                testSelButton4.Visible = true; testSelButton5.Visible = true; testSelButton6.Visible = true; testSelButton7.Visible = true;
                ...
                testResult1.ForeColor = Color.LightGray; testResult1.ForeColor = Color.LightGray; testResult1.Text = "NT";
                testResult2.ForeColor = Color.LightGray; testResult2.ForeColor = Color.LightGray; testResult2.Text = "NT";
                testResult3.ForeColor = Color.LightGray; testResult3.ForeColor = Color.LightGray; testResult3.Text = "NT";
                testResult4.ForeColor = Color.LightGray; testResult4.ForeColor = Color.LightGray; testResult4.Text = "NT";
                testResult5.ForeColor = Color.LightGray; testResult5.ForeColor = Color.LightGray; testResult5.Text = "NT";
                testResult6.ForeColor = Color.LightGray; testResult6.ForeColor = Color.LightGray; testResult6.Text = "NT";
                testResult7.ForeColor = Color.LightGray; testResult7.ForeColor = Color.LightGray; testResult7.Text = "NT";
            }
            ...
            {
                testSelButton0.Visible = true; testSelButton1.Visible = true; testSelButton2.Visible = true; testSelButton3.Visible = true;
                testSelButton4.Visible = true; testSelButton5.Visible = true; testSelButton6.Visible = true;
                testSelButton0.Text = "MP3 Input Sensitivity / Max. SPL -------------------------------------------------------------------------------------------";
                testSelButton1.Text = "Volume Control Knob Function -----------------------------------------------------------------------------------------------";
                testSelButton2.Text = "Microphone Input Sensitivity -----------------------------------------------------------------------------------------------";
            ...
            {  //sp
                testSelButton0.Visible = true; testSelButton1.Visible = true; testSelButton2.Visible = true; testSelButton3.Visible = true; testSelButton6.Visible = true;
                testSelButton0.Text = "MP3 Input Sensitivity / Max. SPL -------------------------------------------------------------------------------------------";
                testSelButton1.Text = "Volume Control Knob Function -----------------------------------------------------------------------------------------------";
                testSelButton2.Text = "Microphone Input Sensitivity ------------------------------------------------------------------------------------------------";
                testSelButton6.Text = "System Background Noise Output ----------------------------------------------------------------------------------------------";
                ...
                (productButton20.Checked) || (DUT.productModel == "SS300") ) //DS60-X, DS60-XL, SS-X60 & SS-X120, SS100/300
            {
                ...
                {
                    testSelButton3.Visible = true; testSelButton4.Visible = true; testSelButton5.Visible = true;
                    testSelButton0.Visible = true; testSelButton1.Visible = true; testSelButton2.Visible = true;
            ...
            {
                testSelButton0.Visible = true; testSelButton1.Visible = true; testSelButton2.Visible = true; testSelButton3.Visible = true; testSelButton8.Visible = true;
                testSelButton4.Visible = true; testSelButton5.Visible = true; testSelButton6.Visible = true; testSelButton7.Visible = true; 
                AUXCableOption.Visible = true;
                if (AUXCableOption.Checked == false) { testSelButton9.Visible = true; }
          ...
          //      testSelButton9.Text = "AUX Cable -------------------------------------------------------------------------------------------------------------------";
                if (AUXCableOption.Checked == false) { testSelButton9.Text = "AUX Cable -------------------------------------------------------------------------------------------------------------------"; }
                ...
                testResult6.ForeColor = Color.LightGray; testResult6.ForeColor = Color.LightGray; testResult6.Text = "NT";
                testResult7.ForeColor = Color.LightGray; testResult7.ForeColor = Color.LightGray; testResult7.Text = "NT";
                testResult8.ForeColor = Color.LightGray; testResult8.ForeColor = Color.LightGray; testResult8.Text = "NT";
              //  testResult9.ForeColor = Color.LightGray; testResult9.ForeColor = Color.LightGray; testResult9.Text = "NT";
                if (AUXCableOption.Checked == false) { testResult9.ForeColor = Color.LightGray; testResult9.ForeColor = Color.LightGray; testResult9.Text = "NT"; }
            }
            else if (DUT.productModel == "SS400")
            {
                testSelButton0.Visible = true; testSelButton1.Visible = true;
            ...
            {                
                testSelButton0.Visible = true; testSelButton1.Visible = true; testSelButton6.Visible = true;
        ...
        {
            SN1_Label.Visible = true; SN2_Label.Visible = true; SN3_Label.Visible = true; SN4_Label.Visible = true; SN5_Label.Visible = false;
            SN6_Label.Visible = false; SN7_Label.Visible = false; SN8_Label.Visible = false; SN9_Label.Visible = false; SN10_Label.Visible = false;

            SN1_Label.Text = "System"; SN2_Label.Text = "Control Unit"; SN3_Label.Text = "Electronics"; SN4_Label.Text = "Microphone";

            SN_Box1.Visible = true; SN_Box2.Visible = true; SN_Box3.Visible = true; SN_Box4.Visible = true; SN_Box10.Visible = false;
            SN_Box5.Visible = false; SN_Box6.Visible = false; SN_Box7.Visible = false; SN_Box8.Visible = false; SN_Box9.Visible = false; SN_Box10.Visible = false;
            ...
            SN_Box1.Text = null; SN_Box2.Text = null; SN_Box3.Text = null; SN_Box4.Text = null; SN_Box5.Text = null;
            ...
            if ((productButton0.Checked) || (DUT.productModel == "500X") || (productButton5.Checked) || (productButton8.Checked))
            {
                ...
                {
                    SN_Box5.Visible = true; SN5_Label.Visible = true; SN5_Label.Text = "Battery";
                    if (DUT.productModel == "100X-NAVY")
                    {
                        SN2_Label.Visible = false; SN_Box2.Visible = false;
                    }
                }
            ...
            {
                SN2_Label.Visible = false; SN_Box2.Visible = false; SN4_Label.Visible = false; SN_Box4.Visible = false;
                SN3_Label.Text = "2U Chassis";
            }
            else if (DUT.productModel == "1000Xi")
            {
                SN5_Label.Visible = true; SN_Box5.Visible = true;
                SN5_Label.Text = "CarbonFiber Hd";
            }
            else if (DUT.productModel == "1000")
            {
                SN5_Label.Visible = true; SN6_Label.Visible = true; SN7_Label.Visible = true; SN_Box5.Visible = true; SN_Box6.Visible = true; SN_Box7.Visible = true;
                SN1_Label.Text = "1000-AHD-G"; SN2_Label.Text = "X-MP3-AL"; SN3_Label.Text = "1000-AMP"; SN4_Label.Text = "X-MIC-AL"; SN5_Label.Text = "1000-G-SYS";
                SN6_Label.Text = "1000-AC-PWR"; SN7_Label.Text = "PHRASLTR-2";
            }
            ...
            {
                SN2_Label.Visible = false; SN3_Label.Visible = false; SN4_Label.Visible = false;
                SN_Box2.Visible = false; SN_Box3.Visible = false; SN_Box4.Visible = false;
            }
            else if ((productButton12.Checked) || (productButton13.Checked))   //60DS w Tranfs
            {
                SN3_Label.Visible = false; SN4_Label.Visible = false;
                SN_Box3.Visible = false; SN_Box4.Visible = false;
            ...
            else if (productButton15.Checked)   //SS
            {
                ...
                {
                    SN4_Label.Visible = false; SN_Box4.Visible = false; SN3_Label.Text = "Transformer";
                }
            ...
            {
                SN5_Label.Visible = true; SN6_Label.Visible = true; SN7_Label.Visible = true; SN8_Label.Visible = true; SN9_Label.Visible = true; SN10_Label.Visible = true;
                SN_Box5.Visible = true; SN_Box6.Visible = true; SN_Box7.Visible = true; SN_Box8.Visible = true; SN_Box9.Visible = true; SN_Box9.Visible = true; SN_Box10.Visible = true;
                SN2_Label.Text = "Firmware Ver"; SN3_Label.Text = "Electronics"; SN4_Label.Text = "Head No 1"; SN5_Label.Text = "Head No 2";
                SN6_Label.Text = "AMC No 1"; SN7_Label.Text = "AMC No 2"; SN8_Label.Text = "Light"; SN9_Label.Text = "Camera"; SN10_Label.Text = "48VDC Ext PS";

                if (DUT.productModel == "1000RX")
                {
                    SN_Box5.Text = "N/A"; SN_Box5.Enabled = false;
                }
                else
                {
                    SN_Box5.Text = ""; SN_Box5.Enabled = true;
                    if(DUT.productModel=="950NXT")
                    {
                        SN6_Label.Text = "K300 PC"; SN7_Label.Text = "Main PWR PCA";
                    }
                }
            }
        ...
        {
            driverSN_Box1.Visible = false; driverSN_Box2.Visible = false; driverSN_Box3.Visible = false; driverSN_Box4.Visible = false;
            driverSN_Box5.Visible = false; driverSN_Box6.Visible = false; driverSN_Box7.Visible = false; driverSN_Box8.Visible = false;
            ...
            {
                driverSN_Box1.Visible = true; driverSN_Box2.Visible = true;
            }
            ...
            {
                driverSN_Box1.Visible = true; driverSN_Box2.Visible = true; driverSN_Box3.Visible = true; driverSN_Box4.Visible = true;
            }
            ...
            {
                driverSN_Box1.Visible = true; driverSN_Box2.Visible = true; driverSN_Box3.Visible = true; driverSN_Box4.Visible = true;
                driverSN_Box5.Visible = true; driverSN_Box6.Visible = true; driverSN_Box7.Visible = true;
            }
            else if (productButton19.Checked)
            {
                driverSN_Box1.Visible = true; driverSN_Box2.Visible = true; driverSN_Box3.Visible = true; driverSN_Box4.Visible = true;
                driverSN_Box5.Visible = true; driverSN_Box6.Visible = true; driverSN_Box7.Visible = true; driverSN_Box8.Visible = true;
            }
            else if (productButton20.Checked)
            {
                if ((modelButton0.Checked) || (modelButton1.Checked)) { driverSN_Box1.Visible = true; }
                else if ((modelButton2.Checked) || (modelButton3.Checked) || (modelButton4.Checked)) { driverSN_Box1.Visible = driverSN_Box2.Visible = true; }
                else { driverSN_Box1.Visible = driverSN_Box2.Visible = driverSN_Box3.Visible = driverSN_Box4.Visible = true; }
            }
            else if (productButton21.Checked)
            {
                if (modelButton0.Checked) { driverSN_Box1.Visible = true; }
                else { driverSN_Box1.Visible = driverSN_Box2.Visible = true; }
            }
            else if (productButton22.Checked)
            {
                driverSN_Box1.Visible = true; driverSN_Box2.Visible = true;

                if (DUT.productModel == "360XL-MID 2-ST") { driverSN_Box2.Text = ""; }
                else { driverSN_Box2.Text = "NA"; }
            }
            else { }
        ...
        {
            if (DUT.Debug == 0) { if (MissingSN()) return; }
            ...
            if (troubleShootingCheckBox.Checked) { recordSampleInfo(true); }
            else { recordSampleInfo(false); }
            ...
            {             
                ...
                {
                    if (SetupSequenceSelect("MP3_Ch1", "FreqSweep", GetRefFileName(), GetRefFileNamePlus(), GetRefFileNameMinus())) { De_activateUserInputs(false); return; };
                ...
                /******************************************************************************************************************************************************************/
                if (SetupSequenceSelect("MP3_Ch1", "FR", GetRefFileName(), GetRefFileNamePlus(), GetRefFileNameMinus())) { De_activateUserInputs(false); return; };

                runFRTest(FileNameForFR, null);
                DisplayTestResults("FR");
                
                if (SetupSequenceSelect("MP3_Ch1", "SPL", GetRefFileName(), GetRefFileNamePlus(), GetRefFileNameMinus())) { De_activateUserInputs(false); return; };
            ...
            //    testResult1.ForeColor = Color.LightGray; testResult1.Text = "NT"; testResult1.Update();
                ...
                if(DUT.Debug ==1) { debugLabel6.Text = "Test 0 sensitivity=" + DUT.PFForTest0Sel[0] + ", SPL=" + DUT.PFForTest0Sel[1]; }
           ...
           //     testResult2.ForeColor = Color.LightGray; testResult2.Text = "NT     "; testResult2.Update();            
                ...
                {
                    if (SetupSequenceSelect("MP3_Ch1", "RX_SPL", GetRefFileName(), GetRefFileNamePlus(), GetRefFileNameMinus())) { De_activateUserInputs(false); return; };
                ...
                {
                    if (SetupSequenceSelect("MIC_Ch2", "FR", GetRefFileName(), GetRefFileNamePlus(), GetRefFileNameMinus())) { De_activateUserInputs(false); return; };  //AP output CH2 --> MIC
                }
                else
                {
                    if (SetupSequenceSelect("MP3_Ch1", "FR", GetRefFileName(), GetRefFileNamePlus(), GetRefFileNameMinus())) { De_activateUserInputs(false); return; }; //AP output CH1 --> MP3
                }
            ...
            //    testResult6.ForeColor = Color.LightGray; testResult6.Text = ""; testResult6.Update();
                ...
                if (SetupSequenceSelect("MP3_Ch1", "Noise", GetRefFileName(), GetRefFileNamePlus(), GetRefFileNameMinus())) { De_activateUserInputs(false); return; };
          ...
          /*      else
           ...
           //     testResult9.ForeColor = Color.LightGray; testResult9.Text = ""; testResult9.Update();
                ...
                if (troubleShootingCheckBox.Checked) { FileNameForFR = "\\Screening Test 9 (Ring) - "; }
                else { FileNameForFR = "\\[" + DUT.SN[1] + "] AUX Cable (Ring) - "; }          
        ...
        private void DisplayTestResults(string ResultType)
        {
            if (testSelButton0.Checked)
            {
                if (productButton18.Checked)  //RXs
                {
                    if (!troubleShootingCheckBox.Checked) { reportPassFail0.Text = DUT.FRTestStatus; }

                   // reportPassFail0.Text = "PASSED"; //SPDebug

                    testResult0.Text = DUT.FRTestStatus;

                    if (DUT.FRTestStatus == "FAILED") { testResult0.ForeColor = Color.Red; }
                    else { testResult0.ForeColor = Color.LightGreen; }                  
                }
                else
                {
                    if (ResultType == "FR")
                    ...
                    {                        
                        if (((productButton12.Checked) || (productButton13.Checked) || (productButton15.Checked) || (productButton16.Checked)) && (!troubleShootingCheckBox.Checked))  //models w Trans
                        {
                            ...
                            else if (DUT.productModel != "SS400") { reportPassFail3.Text = DUT.SPLTestStatus; }
                        }   
                        ...
                        {
                            if (!troubleShootingCheckBox.Checked) { reportPassFail1.Text = DUT.SPLTestStatus; }                           
                        }
            ...
            else if (testSelButton1.Checked)
            {
                if ((productButton18.Checked) || (DUT.productModel == "SS400")) //RXs & SS400
                {
                 ...
                 //   reportPassFail1.Text = "PASSED"; //SPDebug
                    ...
                    if (DUT.SPLTestStatus == "FAILED") { testResult1.ForeColor = Color.Red; }
                    else { testResult1.ForeColor = Color.LightGreen; }
                }
                else
                {
                    testResult1.Text = DUT.PFPerTestItem[1] = DUT.FRTestStatus;
                   
                    if (!troubleShootingCheckBox.Checked) {  reportPassFail1.Text = DUT.FRTestStatus; }

                    if (DUT.FRTestStatus == "FAILED") { testResult1.ForeColor = Color.Red; }
                    else { testResult1.ForeColor = Color.LightGreen; }
                }
            ...
            else if (testSelButton2.Checked)
            {
                ...
                if (!troubleShootingCheckBox.Checked) { reportPassFail2.Text = DUT.FRTestStatus; }

                if (DUT.FRTestStatus == "FAILED") { testResult2.ForeColor = Color.Red; }
                else { testResult2.ForeColor = Color.LightGreen; }
            }
            else if (testSelButton3.Checked)
            {
                testResult3.Text = DUT.PFPerTestItem[3] = DUT.FRTestStatus;
               
                if (DUT.FRTestStatus == "FAILED") { testResult3.ForeColor = Color.Red; }
                else { testResult3.ForeColor = Color.LightGreen; }
      ...
      //        if ((DUT.productModel == "100X-NAVY") || (DUT.productModel == "1000XVB"))
                    ...
                    {
                        if (!troubleShootingCheckBox.Checked) { reportPassFail3.Text = "FAILED"; }                       
                    }
                    else if ((testResult3.Text == "PASSED") && (testResult4.Text == "PASSED"))
                    {
                        if (!troubleShootingCheckBox.Checked) { reportPassFail3.Text = "PASSED"; }
                    }
                    else
                    {
                ...
                {
                    if (!troubleShootingCheckBox.Checked) { reportPassFail3.Text = DUT.FRTestStatus; }
                }
            ...
            else if (testSelButton4.Checked)
            {
                ...
                if (DUT.FRTestStatus == "FAILED") { testResult4.ForeColor = Color.Red; }
                else { testResult4.ForeColor = Color.LightGreen; }
            }
            else if (testSelButton5.Checked)
            {
                ...
                if (DUT.productModel == "100X-NAVY")
                {
                    if (!troubleShootingCheckBox.Checked) { reportPassFail4.Text = DUT.FRTestStatus; }
                }
                else if (productButton20.Checked)
                {
                    if (!troubleShootingCheckBox.Checked)
                ...
                if (DUT.FRTestStatus == "FAILED") { testResult5.ForeColor = Color.Red; }
                else { testResult5.ForeColor = Color.LightGreen; }
            }
            else if (testSelButton6.Checked)
            {
                ...
                {
                    if (!troubleShootingCheckBox.Checked) { reportPassFail3.Text = DUT.NoiseTestStatus; }
                //    reportPassFail3.Text = "PASSED"; //SPDebug
                }
                else if (DUT.productModel == "100X-NAVY")
                {
                    if (!troubleShootingCheckBox.Checked) { reportPassFail5.Text = DUT.NoiseTestStatus; }
                }
                else
                {
                    if (!troubleShootingCheckBox.Checked) { reportPassFail4.Text = DUT.NoiseTestStatus; }
                }

                if (DUT.NoiseTestStatus == "FAILED") { testResult6.ForeColor = Color.Red; }
                else { testResult6.ForeColor = Color.LightGreen; }
            }
            else if (testSelButton7.Checked)
            {
                if (DUT.productModel == "100X-NAVY") //100X-NAVY IPOD Sen & Max SPL
                {
                    if ((DUT.FRTestStatus == "FAILED") || (DUT.SPLTestStatus == "FAILED"))
                    {
                        ...
                        if (!troubleShootingCheckBox.Checked) { reportPassFail6.Text = "FAILED"; }
                    }
                    if ((DUT.FRTestStatus == "PASSED") && (DUT.SPLTestStatus == "PASSED"))
                    {
                        ...
                        if (!troubleShootingCheckBox.Checked) { reportPassFail6.Text = "PASSED"; }
                    }
                }
                else
                {
                    ...
                    if (AUXCableOption.Checked)
                    {
                        if (!troubleShootingCheckBox.Checked)
                        {
                            if (testResult7.Text == "FAILED") { reportPassFail5.Text = "FAILED"; }
                            else if (testResult7.Text == "PASSED") { reportPassFail5.Text = "PASSED"; }
                        }
                        else { reportPassFail5.Text = "NC"; }
                    }
                    else
                    {
                        if (!troubleShootingCheckBox.Checked)
                        {
                            if ((testResult7.Text == "FAILED") || (testResult9.Text == "FAILED")) { reportPassFail5.Text = "FAILED"; }
                            else if ((testResult7.Text == "PASSED") && (testResult9.Text == "PASSED")) { reportPassFail5.Text = "PASSED"; }
                        }
                        else { reportPassFail5.Text = "NC"; }
                    }
                }
            ...
            else if (testSelButton9.Checked)
            {
                if (productButton18.Checked) //if RX's
                {
                    if (!troubleShootingCheckBox.Checked) { reportPassFail2.Text = DUT.PFPerTestItem[9] = testResult9.Text; }
        ...
        private string GetRefFileName()
        {
            ...
            if (testSelButton0.Checked) { RefFileName = ModelName + " Test 0 Ref.xlsx"; }
            else if (testSelButton1.Checked) { RefFileName = ModelName + " Test 1 Ref.xlsx"; }
            else if (testSelButton2.Checked) { RefFileName = ModelName + " Test 2 Ref.xlsx"; }
            else if (testSelButton3.Checked) { RefFileName = ModelName + " Test 3 Ref.xlsx"; }
            else if (testSelButton4.Checked) { RefFileName = ModelName + " Test 4 Ref.xlsx"; }
            else if (testSelButton5.Checked) { RefFileName = ModelName + " Test 5 Ref.xlsx"; }
            else if (testSelButton6.Checked) { RefFileName = ModelName + " Test 6 Ref.xlsx"; }
            else if (testSelButton7.Checked) { RefFileName = ModelName + " Test 7 Ref.xlsx"; }
            else if (testSelButton9.Checked) { RefFileName = ModelName + " Test 9 Ref.xlsx"; }
        ...
        void GetTestParameters(String DriveLevelFR, String DriveLevelSPL, String RefLower, String RefUpper, String WindowingBegin, String WindowingEnd, String FreqSPL)
        {
            ...
            try { DUT.stimulusFR = Convert.ToDouble(ini.IniReadValue(ModelName, DriveLevelFR)); }
            catch (Exception) { DUT.stimulusFR = Convert.ToDouble(ini.IniReadValue("RefData", DriveLevelFR)); }

            try { DUT.stimulusSPL = Convert.ToDouble(ini.IniReadValue(ModelName, DriveLevelSPL)); }
            catch (Exception) { DUT.stimulusSPL = Convert.ToDouble(ini.IniReadValue("RefData", DriveLevelSPL)); }

            try { DUT.SweepLowerLimit = Convert.ToDouble(ini.IniReadValue(ModelName, RefLower)); }
            catch (Exception) { DUT.SweepLowerLimit = Convert.ToDouble(ini.IniReadValue("RefData", RefLower)); }

            try { DUT.SweepUpperLimit = Convert.ToDouble(ini.IniReadValue(ModelName, RefUpper)); }
            catch (Exception) { DUT.SweepUpperLimit = Convert.ToDouble(ini.IniReadValue("RefData", RefUpper)); }

            try { DUT.WindowBegin = Convert.ToDouble(ini.IniReadValue(ModelName, WindowingBegin)); }
            catch (Exception) { DUT.WindowBegin = Convert.ToDouble(ini.IniReadValue("RefData", WindowingBegin)); }

            try { DUT.WindowEnd = Convert.ToDouble(ini.IniReadValue(ModelName, WindowingEnd)); }
            catch (Exception) { DUT.WindowEnd = Convert.ToDouble(ini.IniReadValue("RefData", WindowingEnd)); }

            try { DUT.freqStart = Convert.ToInt16(ini.IniReadValue(ModelName, "FreqStart")); }  //For FR sweep range
            catch (Exception) { DUT.freqStart = Convert.ToInt16(ini.IniReadValue("RefData", "FreqStart")); }

            try { DUT.freqStop = Convert.ToInt16(ini.IniReadValue(ModelName, "FreqStop")); }    //For FR sweep range
            catch (Exception) { DUT.freqStop = Convert.ToInt16(ini.IniReadValue("RefData", "FreqStop")); }

            try { DUT.freqSPL = Convert.ToInt16(ini.IniReadValue(ModelName, FreqSPL)); }
            catch (Exception) { DUT.freqSPL = Convert.ToInt16(ini.IniReadValue("RefData", FreqSPL)); }
           
            if (testSelButton0.Checked)
            {
                try { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "RefSPL")); }
                catch (Exception) { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue("RefData", "RefSPL")); }

                try { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLLowerLimit")); }
                catch (Exception) { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLLowerLimit")); }
                try { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLUpperLimit")); }
                catch (Exception) { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLUpperLimit")); }
             ...
             //   remarkBox.Text = "Ref=" + Convert.ToString(DUT.RefSPL) + ", Lower=" + Convert.ToString(DUT.SPLLowerLimit) + ", Upper=" + Convert.ToString(DUT.SPLUpperLimit);
                ...
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test0_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test0_FR_graphTitle"); }

                DUT.SPLGraphTitle = ini.IniReadValue(ModelName, "Test0_SPL_graphTitle");
                if (DUT.SPLGraphTitle == "") { DUT.SPLGraphTitle = ini.IniReadValue("RefData", "Test0_SPL_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax")); }

                try { DUT.YAxisMaxSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMaxSPL")); }
                catch (Exception) { DUT.YAxisMaxSPL = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMaxSPL")); }
                try { DUT.YAxisMinSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMinSPL")); }
                catch (Exception) { DUT.YAxisMinSPL = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMinSPL")); }
            }
            else if (testSelButton1.Checked)
            {
                
                try { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "RefSPL1")); }
                catch (Exception) { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue("RefData", "RefSPL1")); }
                                
                try { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLLowerLimit1")); }   //Only for SS400 accelerometer output
                catch (Exception) { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLLowerLimit1")); }
                try { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLUpperLimit1")); }
                catch (Exception) { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLUpperLimit1")); }

                DUT.curveSmooth = ini.IniReadValue(ModelName, "curveSmooth1");
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth1"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test1_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test1_FR_graphTitle"); }

                DUT.SPLGraphTitle = ini.IniReadValue(ModelName, "Test1_SPL_graphTitle");
                if (DUT.SPLGraphTitle == "") { DUT.SPLGraphTitle = ini.IniReadValue("RefData", "Test1_SPL_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin1")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin1")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax1")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax1")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin1")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin1")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax1")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax1")); }

                try { DUT.YAxisMaxSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMaxSPL1")); }            //Graphics scal for RX only
                catch (Exception) { DUT.YAxisMaxSPL = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMaxSPL1")); }
                try { DUT.YAxisMinSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMinSPL1")); }
                catch (Exception) { DUT.YAxisMinSPL = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMinSPL1")); }
            }
            else if (testSelButton2.Checked)
            {
                try { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "RefSPL2")); }
                catch (Exception) { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue("RefData", "RefSPL2")); }

                try { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLLowerLimit2")); }   //Only for RX Alert Tone SPL
                catch (Exception) { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLLowerLimit2")); }
                try { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLUpperLimit2")); }
                catch (Exception) { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLUpperLimit2")); }

                DUT.curveSmooth = ini.IniReadValue(ModelName, "curveSmooth2");
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth2"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test2_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test2_FR_graphTitle"); }

                DUT.SPLGraphTitle = ini.IniReadValue(ModelName, "Test2_SPL_graphTitle");
                if (DUT.SPLGraphTitle == "") { DUT.SPLGraphTitle = ini.IniReadValue("RefData", "Test2_SPL_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin2")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin2")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax2")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax2")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin2")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin2")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax2")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax2")); }
            }
            else if (testSelButton3.Checked)
            {
                try { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "RefSPL3")); }
                catch (Exception) { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue("RefData", "RefSPL3")); }

                try { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLLowerLimit3")); }
                catch (Exception) { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLLowerLimit3")); }
                try { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLUpperLimit3")); }
                catch (Exception) { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLUpperLimit3")); }

                DUT.curveSmooth = ini.IniReadValue(ModelName, "curveSmooth3");
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth3"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test3_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test3_FR_graphTitle"); }

                DUT.SPLGraphTitle = ini.IniReadValue(ModelName, "Test3_SPL_graphTitle");
                if (DUT.SPLGraphTitle == "") { DUT.SPLGraphTitle = ini.IniReadValue("RefData", "Test3_SPL_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin3")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin3")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax3")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax3")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin3")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin3")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax3")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax3")); }
            }
            else if (testSelButton4.Checked)
            {
                DUT.curveSmooth = ini.IniReadValue(ModelName, "curveSmooth4");
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth4"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test4_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test4_FR_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin4")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin4")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax4")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax4")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin4")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin4")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax4")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax4")); }
            }
            else if (testSelButton5.Checked)
            {
                DUT.curveSmooth = ini.IniReadValue(ModelName, "curveSmooth5");
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth5"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test5_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test5_FR_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin5")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin5")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax5")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax5")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin5")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin5")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax5")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax5")); }
            }
            else if (testSelButton6.Checked)
            {
         ...
         //       catch (Exception) { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue("RefData", "RefNoise")); }   //NOT need, noise test was based on noise profile across Freq Spectrum
                ...
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test6_FR_graphTitle"); }

                try { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLUpperLimit6")); }
                catch (Exception) { DUT.SPLUpperLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLUpperLimit6")); }
                try { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue(ModelName, "SPLLowerLimit6")); }
                catch (Exception) { DUT.SPLLowerLimit = Convert.ToDouble(ini.IniReadValue("RefData", "SPLLowerLimit6")); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin6")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin6")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax6")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax6")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin6")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin6")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax6")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax6")); }
            }
            else if (testSelButton7.Checked)
            {
                try { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue(ModelName, "RefSPL7")); }
                catch (Exception) { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue("RefData", "RefSPL7")); }

                DUT.curveSmooth = ini.IniReadValue(ModelName, "curveSmooth7");
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth7"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test7_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test7_FR_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin7")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin7")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax7")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax7")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin7")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin7")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax7")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax7")); }
            }
            else if (testSelButton8.Checked)
            {
            }
            else if (testSelButton9.Checked)
            {
                ...
                if (DUT.curveSmooth == "") { DUT.curveSmooth = ini.IniReadValue("RefData", "curveSmooth9"); }

                DUT.graphTitle = ini.IniReadValue(ModelName, "Test9_FR_graphTitle");
                if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", "Test9_FR_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMin9")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin9")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "XAxisMax9")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax9")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMin9")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin9")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(ModelName, "YAxisMax9")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax9")); }
            }
        }

        private void RetriveTestSetup(object sender, EventArgs e)
        {
            try { DUT.freqStart = Convert.ToInt16(ini.IniReadValue(DUT.productModel, "FreqStart")); }  //For FR sweep range
            catch (Exception) { DUT.freqStart = Convert.ToInt16(ini.IniReadValue("RefData", "FreqStart")); }

            try { DUT.freqStop = Convert.ToInt16(ini.IniReadValue(DUT.productModel, "FreqStop")); }    //For FR sweep range
            catch (Exception) { DUT.freqStop = Convert.ToInt16(ini.IniReadValue("RefData", "FreqStop")); }           
            ...
            if (testSelButton0.Checked)
            {
                ...
                try { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "Ref_SPL")); }
                catch (Exception) { DUT.RefSPL = Convert.ToDouble(ini.IniReadValue("RefData", "Ref_SPL")); }

                try { DUT.RefSS400MicInput = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "Ref_SS400MicInput")); }
                catch (Exception) { DUT.RefSS400MicInput = Convert.ToDouble(ini.IniReadValue("RefData", "Ref_SS400MicInput")); }
                ...
                if (DUT.SS400MicInputGraphTitle == "") { DUT.SS400MicInputGraphTitle = ini.IniReadValue("RefData", "Test0_MIC_graphTitle"); }

                try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "XAxisMin")); }
                catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMin")); }
                try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "XAxisMax")); }
                catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "XAxisMax")); }

                try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "YAxisMin")); }
                catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMin")); }
                try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "YAxisMax")); }
                catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMax")); }

                try { DUT.YAxisMaxSPL = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "YAxisMaxSPL")); }
                catch (Exception) { DUT.YAxisMaxSPL = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMaxSPL")); }
                try { DUT.YAxisMinSPL = Convert.ToDouble(ini.IniReadValue(DUT.productModel, "YAxisMinSPL")); }
                catch (Exception) { DUT.YAxisMinSPL = Convert.ToDouble(ini.IniReadValue("RefData", "YAxisMinSPL")); }
            ...
            else
            {
                ...
                if (testSelButton1.Checked)
                {
                    ...
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction1"); }

                    Title = "Test1_graphTitle"; YMin = "YAxisMin1"; YMax = "YAxisMax1";
                    XMin = "XAxisMin1"; XMax = "XAxisMax1"; CurveSmooth = "curveSmooth1";
                }
                else if (testSelButton2.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction2");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction2"); }

                    Title = "Test2_graphTitle"; YMin = "YAxisMin2"; YMax = "YAxisMax2";
                    XMin = "XAxisMin2"; XMax = "XAxisMax2"; CurveSmooth = "curveSmooth2";
                }
                else if (testSelButton3.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction3");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction3"); }

                    Title = "Test3_graphTitle"; YMin = "YAxisMin3"; YMax = "YAxisMax3";
                    XMin = "XAxisMin3"; XMax = "XAxisMax3"; CurveSmooth = "curveSmooth3";
                }
                else if (testSelButton4.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction4");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction4"); }

                    Title = "Test4_graphTitle"; YMin = "YAxisMin4"; YMax = "YAxisMax4";
                    XMin = "XAxisMin4"; XMax = "XAxisMax4"; CurveSmooth = "curveSmooth4";
                }
                else if (testSelButton5.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction5");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction5"); }

                    Title = "Test5_graphTitle"; YMin = "YAxisMin5"; YMax = "YAxisMax5";
                    XMin = "XAxisMin5"; XMax = "XAxisMax5"; CurveSmooth = "curveSmooth5";
                }
                else if (testSelButton6.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction6");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction6"); }

                    Title = "Test6_graphTitle"; YMin = "YAxisMin6"; YMax = "YAxisMax6";
                    XMin = "XAxisMin6"; XMax = "XAxisMax6"; CurveSmooth = "curveSmooth6";
                }
                else if (testSelButton7.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction7");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction7"); }

                    Title = "Test7_graphTitle"; SPLTitle = "Test7_SPL_graphTitle";
                    YMin = "YAxisMin7"; YMax = "YAxisMax7";
                    XMin = "XAxisMin7"; XMax = "XAxisMax7"; CurveSmooth = "curveSmooth7";
                }
                else if (testSelButton8.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction8");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction8"); }
                }
                else if (testSelButton9.Checked)
                {
                    setupInstruction.Text = ini.IniReadValue(DUT.productModel, "SetupInstruction9");
                    if (setupInstruction.Text == "") { setupInstruction.Text = ini.IniReadValue("RefData", "SetupInstruction9"); }

                    Title = "Test9_graphTitle"; YMin = "YAxisMin9"; YMax = "YAxisMax9";
                    XMin = "XAxisMin9"; XMax = "XAxisMax9"; CurveSmooth = "curveSmooth9";
                }

                if (!testSelButton8.Checked)
                {
                    DUT.graphTitle = ini.IniReadValue(DUT.productModel, Title);
                    if (DUT.graphTitle == "") { DUT.graphTitle = ini.IniReadValue("RefData", Title); }

                    DUT.SPLGraphTitle = ini.IniReadValue(DUT.productModel, SPLTitle);
                    if (DUT.SPLGraphTitle == "") { DUT.SPLGraphTitle = ini.IniReadValue("RefData", SPLTitle); }

                    try { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue(DUT.productModel, YMin)); }
                    catch (Exception) { DUT.YAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", YMin)); }
                    try { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue(DUT.productModel, YMax)); }
                    catch (Exception) { DUT.YAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", YMax)); }

                    try { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue(DUT.productModel, XMin)); }
                    catch (Exception) { DUT.XAxisMin = Convert.ToDouble(ini.IniReadValue("RefData", XMin)); }
                    try { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue(DUT.productModel, XMax)); }
                    catch (Exception) { DUT.XAxisMax = Convert.ToDouble(ini.IniReadValue("RefData", XMax)); }
        ...
        {
            DUT.SN[0] = oper_Ini.Text; reportOperIni.Text = "Test Operator: " + oper_Ini.Text;

            if (troubleShootingMode) { DUT.SN[1] = "Screening"; }
            else { DUT.SN[1] = SN_Box1.Text; }


            DUT.SN[2] = SN_Box2.Text; DUT.SN[3] = SN_Box3.Text; DUT.SN[4] = SN_Box4.Text; DUT.SN[5] = SN_Box5.Text;
            DUT.SN[6] = SN_Box6.Text; DUT.SN[7] = SN_Box7.Text; DUT.SN[8] = SN_Box8.Text; DUT.SN[9] = SN_Box9.Text; DUT.SN[10] = SN_Box10.Text;

            DUT.SN[14] = ProductSeriesID();
            DUT.SN[15] = DUT.productModel;
            DUT.WO_No = WO_No.Text;

            DUT.driverSN[1] = driverSN_Box1.Text; DUT.driverSN[2] = driverSN_Box2.Text; DUT.driverSN[3] = driverSN_Box3.Text; DUT.driverSN[4] = driverSN_Box4.Text;
            DUT.driverSN[5] = driverSN_Box5.Text; DUT.driverSN[6] = driverSN_Box6.Text; DUT.driverSN[7] = driverSN_Box7.Text; DUT.driverSN[8] = driverSN_Box8.Text;
       ...
       //     if (DUT.productModel == "1000XVB-100FT") reportModel.Text = "Model: LRAD 1000X";  //Debug
            ...
            if (DUT.productModel == "1000")
            {
                ...
                reportTextBox1.Text = "  LRAD-1000-G-SYS"; reportTextBox2.Text = "  LRAD-1000-AHD-G"; reportTextBox3.Text = "  LRAD-1000-AMP"; reportTextBox4.Text = "  LRAD-1000-AC-PWR";
                reportTextBox5.Text = "  LRAD-X-MP3-AL"; reportTextBox6.Text = "  LRAD-X-MIC-AL"; reportTextBox7.Text = "  LRAD-PHRASLTR-2";

                reportSerialNo1.Text = SN_Box5.Text; reportSerialNo2.Text = SN_Box1.Text; reportSerialNo3.Text = SN_Box3.Text; reportSerialNo4.Text = SN_Box6.Text;
                reportSerialNo5.Text = SN_Box2.Text; reportSerialNo6.Text = SN_Box4.Text; reportSerialNo7.Text = SN_Box7.Text;
            }
            else if (productButton18.Checked)  //LRAD-RX
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  SPEAKER No 1"; reportTextBox3.Text = "  SPEAKER No 2"; reportTextBox4.Text = "  ELECTRONICS";
                reportTextBox5.Text = "  CAMERA"; reportTextBox6.Text = "  LIGHT"; reportTextBox7.Text = "  48VDC PWR SUPPLY";

                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box4.Text; reportSerialNo3.Text = SN_Box5.Text; reportSerialNo4.Text = SN_Box3.Text;
                reportSerialNo5.Text = SN_Box9.Text; reportSerialNo6.Text = SN_Box8.Text; reportSerialNo7.Text = SN_Box10.Text;

                if (DUT.productModel =="1000RX") reportSerialNo3.Text = "NA";
            }
            else if ((productButton1.Checked) || (productButton2.Checked))  //300X's & 450XL's
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  CONTROL UNIT"; reportTextBox3.Text = "  ELECTRONICS"; reportTextBox4.Text = "  MICROPHONE";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box2.Text; reportSerialNo3.Text = SN_Box3.Text; reportSerialNo4.Text = SN_Box4.Text;
            }
            else if (productButton3.Checked)   //500X's
            {
                if (DUT.productModel == "500XRE") { reportTextBox2.Text = "  CONTROL UNIT"; }
                else { reportTextBox2.Text = "  MP3 PLAYER"; }

                reportTextBox1.Text = "  SYSTEM"; reportTextBox3.Text = "  ELECTRONICS"; reportTextBox4.Text = "  MICROPHONE";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box2.Text; reportSerialNo3.Text = SN_Box3.Text; reportSerialNo4.Text = SN_Box4.Text;
            }
            else if ((DUT.productModel == "100X") || (DUT.productModel == "100X-NAVY-V1") || (DUT.productModel == "1000Xi"))
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox3.Text = "  MICROPHONE";
                if (DUT.productModel == "1000Xi") { reportTextBox2.Text = "  CONTROL UNIT"; }
                else { reportTextBox2.Text = "  MP3 PLAYER"; reportTextBox4.Text = "  BATTERY"; reportSerialNo4.Text = SN_Box5.Text; }

                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box2.Text; reportSerialNo3.Text = SN_Box4.Text;
            }
            else if (DUT.productModel == "100X-NAVY")
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  MICROPHONE"; reportTextBox3.Text = "  BATTERY";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box4.Text; reportSerialNo3.Text = SN_Box5.Text;
            }
            ...
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox4.Text = "  MICROPHONE";

                if (productButton11.Checked) { reportTextBox2.Text = "  CONTROL UNIT"; } //DS60 /w amppack
                else { reportTextBox2.Text = "  MP3 PLAYER"; }

                if (productButton9.Checked) { reportTextBox3.Text = "  AMP PACK"; reportTextBox2.Text = "  CONTROL UNIT"; }
                else { reportTextBox3.Text = "  AMP PACK"; }

                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box2.Text; reportSerialNo3.Text = SN_Box3.Text; reportSerialNo4.Text = SN_Box4.Text;
            }
            else if (DUT.productModel == "1000X2U")
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  2U CHASSIS";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box3.Text;
            }
            else if ((productButton12.Checked) || (productButton13.Checked) || (productButton14.Checked))  //DS60-X/XL w Trans and horn only
            {
                ...
                {
                    reportTextBox1.Text = "  SAMPLE"; reportTextBox2.Text = "  DRIVER";
                    reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = driverSN_Box1.Text;
                }
                else
                {
                    reportTextBox1.Text = "  SAMPLE"; reportTextBox2.Text = "  TRANSFORMER"; reportTextBox3.Text = "  DRIVER";
                    reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box2.Text; reportSerialNo3.Text = driverSN_Box1.Text;
                }
            }
            else if (productButton15.Checked)  //SS
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  DRIVER PANEL";
                if (DUT.productModel != "SS400")
                {
                ...
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box2.Text;
            }
            else if (productButton16.Checked)  //SSX w Trans
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  TRANSFORMER";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = SN_Box2.Text;
            }
            ...
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  DRIVER";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = driverSN_Box1.Text;
            }
            ...
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  DRIVER NO 1"; reportTextBox3.Text = "  DRIVER NO 2";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = driverSN_Box1.Text; reportSerialNo3.Text = driverSN_Box2.Text;
            }
            else if (DUT.productModel == "360Xm 4-ST 100V-240W") //360Xm 4-ST                    
            {
                reportTextBox1.Text = "  SYSTEM"; reportTextBox2.Text = "  DRIVER NO 1"; reportTextBox3.Text = "  DRIVER NO 2";
                reportTextBox4.Text = "  DRIVER NO 3"; reportTextBox5.Text = "  DRIVER NO 4";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = driverSN_Box1.Text; reportSerialNo3.Text = driverSN_Box2.Text; reportSerialNo4.Text = driverSN_Box3.Text;
                reportSerialNo5.Text = driverSN_Box4.Text;
            }
            else if (productButton10.Checked)  //360X and XL manifolds
            {
                reportTextBox1.Text = "  MANIFOLD";
                reportTextBox2.Text = "  DRIVER NO 1"; reportTextBox3.Text = "  DRIVER NO 2"; reportTextBox4.Text = "  DRIVER NO 3"; reportTextBox5.Text = "  DRIVER NO 4";
                reportSerialNo1.Text = SN_Box1.Text; reportSerialNo2.Text = driverSN_Box1.Text; reportSerialNo3.Text = driverSN_Box2.Text;
                reportSerialNo4.Text = driverSN_Box3.Text; reportSerialNo5.Text = driverSN_Box4.Text;
            }
            else if (productButton22.Checked)  //360XL-MID
            {
                reportTextBox1.Text = "  SYSTEM"; reportSerialNo1.Text = SN_Box1.Text;
                ...
                (productButton5.Checked) || (productButton7.Checked) || (productButton8.Checked) || (productButton9.Checked) || (productButton11.Checked))
            {
                ...
                {
                    reportAccessoryNo2.Text = "  AUX Cable"; reportAccessoryNo3.Text = "  AC PS To DC Input Cable";
                }
                else if (DUT.productModel == "1000Xi")
                {
                    reportAccessoryNo2.Text = "  AC Power Supply Cable"; reportAccessoryNo3.Text = "  Short (Remote) MP3 cable";
                }
            }
            else if (DUT.productModel == "1000X2U")
            {
            ...
            {
                reportAccessoryNo1.Text = "  IPOD Touch"; reportAccessoryNo2.Text = "  Battery Pack";
            }
        }
        ...
        private string assignAccessoryType()
        {
            ...
            {
                if (modelButton0.Checked) { AccessoryType = "20FT-Cable"; }
                else if (modelButton1.Checked) { AccessoryType = "30FT-Cable"; }
                else if (modelButton2.Checked) { AccessoryType = "100FT-Cable"; }
            }
            else if (productButton12.Checked) //DS60-X /w Transformers
            {
                if (testSelButton0.Checked)
                {
                    if (modelButton0.Checked) { AccessoryType = "70V-60W"; }
                    else if (modelButton1.Checked) { AccessoryType = "100V-60W"; }
                    else if (modelButton2.Checked) { AccessoryType = "25V-80W"; }
                    else if (modelButton3.Checked) { AccessoryType = "70V-80W"; }
                    else if (modelButton4.Checked) { AccessoryType = "100V-80W"; }
                }
                if (testSelButton1.Checked)
                {
                    if (modelButton0.Checked) { AccessoryType = "70V-40W"; }
                    else if (modelButton1.Checked) { AccessoryType = "100V-40W"; }
                    else if (modelButton2.Checked) { AccessoryType = "25V-60W"; }
                    else if (modelButton3.Checked) { AccessoryType = "70V-60W"; }
                    else if (modelButton4.Checked) { AccessoryType = "100V-60W"; }
                }
                if (testSelButton2.Checked)
                {
                    if (modelButton0.Checked) { AccessoryType = "70V-20W"; }
                    else if (modelButton1.Checked) { AccessoryType = "100V-20W"; }
                    else if (modelButton2.Checked) { AccessoryType = "25V-40W"; }
                    else if (modelButton3.Checked) { AccessoryType = "70V-40W"; }
                    else if (modelButton4.Checked) { AccessoryType = "100V-40W"; }
                }
            }
            else if (productButton13.Checked) //DS60-XL /w Transformers
            {
                if (testSelButton0.Checked)
                {
                    if (modelButton0.Checked) { AccessoryType = "70V-160W"; }
                    else if (modelButton1.Checked) { AccessoryType = "100V-160W"; }
                }
                else if (testSelButton1.Checked)
                {
                    if (modelButton0.Checked) { AccessoryType = "70V-120W"; }
                    else if (modelButton1.Checked) { AccessoryType = "100V-120W"; }
                }
                else if (testSelButton2.Checked)
                {
                    if (modelButton0.Checked) { AccessoryType = "70V-80W"; }
                    else if (modelButton1.Checked) { AccessoryType = "100V-80W"; }
                }
            }
        ...
        private string assignFileNameForMaxOutput()
        {
            ...
            if (testSelButton0.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameVOut = "\\Screening Test 0 (SPL) - "; }
                ...
                else if (DUT.productModel == "100X-NAVY") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (MP3-2, MaxPwr-On, VB-Off) - "; }
                //DS60X & DS60XL w transformer
                else if ((productButton12.Checked) || (productButton13.Checked)) { sampleNameVOut = "\\[" + DUT.SN[1] + ", " + AcessoryType + "] Maximum SPL (" + AcessoryType + ") - "; }
                else if ((DUT.productModel == "SS100") || (DUT.productModel == "SS300")) { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (70V-60W Terminal) - "; }
                else if (DUT.productModel == "SSX") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (100V-120W Terminal) - "; }
                else if (DUT.productModel == "SSX wo Trans") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL - "; }
                else if (DUT.productModel == "SSX60") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (100V-60W Terminal) - "; }
                else if (DUT.productModel == "SSX60 wo Trans") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (60W) - "; }
                else if (DUT.productModel == "360X Manifold") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (320W) - "; }
                else if (DUT.productModel == "360XL Manifold") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (640W) - "; }
                else if (DUT.productModel == "SS400") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (360W at 4.0 Ohms) - "; }
                //360Xm with Trans --> Two input powers
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (HIGH Power-TOP) - "; }
                //360Xm with Trans --> One input power
                else if (productButton20.Checked) { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (HIGH Power) - "; }  //360Xm 1-ST wo Trans
                // 360Xm wo Trans-- > One input power
                else if (DUT.productModel == "360Xm 1-ST wo Trans") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL - "; }
                // 360Xm wo Trans-- > Two input power
                else if (DUT.productModel == "360Xm 2-ST wo Trans") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (TOP) - "; }  //
                else { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (Wide-Off) - "; }
            }
            else if (testSelButton1.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameVOut = "\\Screening Test 1 (SPL) - "; }
                else if (productButton18.Checked == true) { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL - "; } //LRAD-RX
                else if (DUT.productModel == "SS400") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Accelerometer Output (With 1kHz Tone) - "; }
                // 360Xm wo Trans-- > Two input power
                else if (DUT.productModel == "360Xm 2-ST wo Trans") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (BOT) - "; }  //
            }
            else if (testSelButton2.Checked) //Alert tone for RXs
            {
                if (troubleShootingCheckBox.Checked) { sampleNameVOut = "\\Screening Test 2 (SPL) - "; }
                else if (productButton18.Checked == true) { sampleNameVOut = "\\[" + DUT.SN[1] + "] Alert Tone SPL - "; } //LRAD-RX               
            }
            else if (testSelButton3.Checked) //Max SPL for 2-ST 360Xm
            {
                if ((troubleShootingCheckBox.Checked) && ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W"))) { sampleNameVOut = "\\Screening Test 3 (SPL) - "; }
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (HIGH Power-BOT) - "; }
            }
            else if (testSelButton7.Checked)
            {
                if ((troubleShootingCheckBox.Checked) && (DUT.productModel == "100X-NAVY")) { sampleNameVOut = "\\Screening Test 7 (SPL) - "; }
                else if (DUT.productModel == "100X-NAVY") { sampleNameVOut = "\\[" + DUT.SN[1] + "] Maximum SPL (IPOD, MaxPwr-On, VB-Off) - "; }
            }
        ...
        private string assignFileNameForFR()
        {
            ...
            if (testSelButton0.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 0 - "; }
                else if ((DUT.productModel == "100X") || (DUT.productModel == "100X-NAVY-V1")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Max Vol) - "; }
                else if (DUT.productModel == "100X-NAVY") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MP3-1, MaxPwr-On, VB-Off) - "; }
                else if (DUT.productModel == "1000X") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Max Output Power, " + AcessoryType + ") - "; }
                else if (DUT.productModel == "1000XVB") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Max Output Power, VB=Off, " + AcessoryType + ") - "; }
                else if (DUT.productModel == "1950XL") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Wide-Off, " + AcessoryType + ") - "; }
                else if (DUT.productModel == "1000X2U") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Max Vol) - "; }
                else if (DUT.productModel == "1000") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Wide-Off) - "; }
                //DS60X & DS60XL w transformer
                else if ((productButton12.Checked) || (productButton13.Checked)) { sampleNameFR = "\\[Hd=" + DUT.SN[1] + ", Transformer Box=" + DUT.SN[2] + "] Sensitivity (" + AcessoryType + ") - "; }
                else if ((DUT.productModel == "SS400") || (DUT.productModel == "DS60-X") || (DUT.productModel == "SSX wo Trans") || (DUT.productModel == "SSX60 wo Trans")) { sampleNameFR = "\\[" + DUT.SN[1] + "] " + "Frequency Response (Sensitivity) - "; }                
                else if (DUT.productModel == "SSX wo Trans") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity - "; }
                else if (DUT.productModel == "SSX60") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (100V-60W Terminal) - "; }
                else if ((DUT.productModel == "SS100") || (DUT.productModel == "SS300")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (70V-60W Terminal) - "; }
                else if (DUT.productModel == "SSX") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (100V-120W Terminal) - "; }
                else if (DUT.productModel == "SSX60 wo Trans") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity - "; }
                else if (DUT.productModel == "360X Manifold") { sampleNameFR = "\\[" + DUT.SN[1] + "] Freq Res - "; }
                else if (DUT.productModel == "360XL Manifold") { sampleNameFR = "\\[" + DUT.SN[1] + "] Freq Res - "; }
                else if (productButton18.Checked) { sampleNameFR = "\\[" + DUT.SN[1] + "] Frequency Sweep (300Hz - 15 kHz) - "; } //LRAD-RX 
                else if (productButton22.Checked) { sampleNameFR = "\\[" + DUT.SN[1] + "] Frequency Response - "; }
                //360Xm 2-ST with Trans --> Two input powers
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (HIGH Power-TOP) - "; }
                //360Xm with Trans --> One input power
                else if ((DUT.productModel == "360Xm 1-ST 25V-60W") || (DUT.productModel == "360Xm 1-ST 100V-60W") || 
                         (DUT.productModel == "360Xm 2-ST 100V-120W") || (DUT.productModel == "360Xm 4-ST 100V-240W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (HIGH Power) - "; }
                //360Xm 1-ST wo Trans --> One input power
                else if (DUT.productModel == "360Xm 1-ST wo Trans") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity - "; }
                //360Xm 2-ST wo Trans --> Two input power
                else if (DUT.productModel == "360Xm 2-ST wo Trans") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (TOP) - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Wide-Off) - "; }

            }
            else if (testSelButton1.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 1 - "; }             
                //DS60X & DS60XL w transformer                
                else if ((productButton12.Checked) || (productButton13.Checked)) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (" + AcessoryType + ") - "; }
                else if (DUT.productModel == "SSX") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (100V-60W Terminal) - "; }
                else if (DUT.productModel == "SSX60") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (100V-40W Terminal) - "; }
                else if ((DUT.productModel == "SS100") || (DUT.productModel == "SS300")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (70V-40W Terminal) - "; }
                //360Xm 2-ST with Trans --> Two input powers
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MID Power-TOP) - "; }
                //360Xm with Trans --> One input power
                else if ((DUT.productModel == "360Xm 1-ST 25V-60W") || (DUT.productModel == "360Xm 1-ST 100V-60W") ||
                         (DUT.productModel == "360Xm 2-ST 100V-120W") || (DUT.productModel == "360Xm 4-ST 100V-240W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MID Power) - "; }                
                //360Xm 2-ST wo Trans --> Two input power
                else if (DUT.productModel == "360Xm 2-ST wo Trans") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (BOT) - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Vol Ctrl Knob Function) - "; }
            }
            else if (testSelButton2.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 2 - "; }
                else if (DUT.productModel == "1000X2U") { sampleNameFR = "\\[" + DUT.SN[1] + "] Mute Function - "; }
                else if ((productButton12.Checked) || (productButton13.Checked)) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (" + AcessoryType + ") - "; }
                else if (DUT.productModel == "SSX") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (100V-30W Terminal) - "; }
                else if (DUT.productModel == "SSX60") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (100V-20W Terminal) - "; }
                else if ((DUT.productModel == "SS100") || (DUT.productModel == "SS300")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (70V-20W Terminal) - "; }
                else if (DUT.productModel == "1000") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MIC input, Wide-Off, Max Vol) - "; }
                //360Xm 2-ST with Trans --> Two input powers
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (LOW Power-TOP) - "; }
                //360Xm with Trans --> One input power
                else if ((DUT.productModel == "360Xm 1-ST 25V-60W") || (DUT.productModel == "360Xm 1-ST 100V-60W") ||
                         (DUT.productModel == "360Xm 2-ST 100V-120W") || (DUT.productModel == "360Xm 4-ST 100V-240W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (LOW Power) - "; }                
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MIC Input) - "; }
            }
            else if (testSelButton3.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 3 - "; }
                else if (DUT.productModel == "1000X") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Low Output Power, " + AcessoryType + ") - "; }
                else if (DUT.productModel == "1000XVB") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Max Output Power, VB=On, " + AcessoryType + ") - "; }
                else if (DUT.productModel == "100X-NAVY") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MP3-2, MaxPwr-On, VB-On) - "; }
                else if (DUT.productModel == "1000") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Wide-On) - "; }
                //360Xm 2-ST with Trans --> Two input powers
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (HIGH Power-BOT) - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Wide-On) - "; }
            }
            else if (testSelButton4.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 4 - "; }
                else if (DUT.productModel == "1000XVB") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Low Output Power, VB=Off, " + AcessoryType + ") - "; }
                else if (DUT.productModel == "100X-NAVY") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MP3-2, MaxPwr-On, VB-Off) - "; }
                else if (DUT.productModel == "1000") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Narrow-Off) - "; }
                //360Xm 2-ST with Trans --> Two input powers
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MID Power-BOT) - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Narrow-Off) - "; }
            }
            else if (testSelButton5.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 5 - "; }
                else if (DUT.productModel == "100X-NAVY") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (MP3-2, MaxPwr-On, VB-Off) - "; }
                else if (DUT.productModel == "1000") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Narrow-On) - "; }
                //360Xm 2-ST with Trans --> Two input powers
                else if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (LOW Power-BOT) - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (Narrow-On) - "; }
            }
            else if (testSelButton6.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 6 - "; }
                else if (DUT.productModel == "1000X2U") { sampleNameFR = "\\[" + DUT.SN[1] + "] Output Noise Level - "; }
                else if (DUT.productModel == "1000") { sampleNameFR = "\\[" + DUT.SN[1] + "] Output Noise Level - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Output Noise Level - "; }
            }
            else if (testSelButton7.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 7 - "; }
                else if (DUT.productModel == "100X-NAVY") { sampleNameFR = "\\[" + DUT.SN[1] + "] Sensitivity (IPOD, MaxPwr-On, VB-Off) - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] Limited Key Switch Function - "; }
            }
            else if (testSelButton9.Checked)
            {
                if (troubleShootingCheckBox.Checked) { sampleNameFR = "\\Screening Test 9 (Tip) - "; }
                else { sampleNameFR = "\\[" + DUT.SN[1] + "] AUX Cable (Tip) - "; }
            }
            return sampleNameFR;
        }
        ...
        private void De_activateUserInputs(bool unLock)
        {
            if (unLock)
            {
                ...
                groupBox4.Enabled = false; groupBox5.Enabled = false; groupBox10.Enabled = false;
            ...
            else
            {
                ...
                groupBox4.Enabled = true; groupBox5.Enabled = true; groupBox10.Enabled = true;
        ...
        private Boolean SetupSequenceSelect(string APOutput, string sequenceID, string refFileName, string refFileNamePlus, string refFileNameMinus)
        {
            ...
            if (sequenceID == "FR")
            {
                try
                {
                    ...
                    if (DUT.curveSmooth == "0") { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().OctaveSmoothing = OctaveSmoothingType.None; }
                    else if (DUT.curveSmooth == "1") { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().OctaveSmoothing = OctaveSmoothingType.Octave1; }
                    else if (DUT.curveSmooth == "3") { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().OctaveSmoothing = OctaveSmoothingType.Octave3; }
                    else if (DUT.curveSmooth == "6") { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().OctaveSmoothing = OctaveSmoothingType.Octave6; }
                    else if (DUT.curveSmooth == "9") { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().OctaveSmoothing = OctaveSmoothingType.Octave9; }
                    else if (DUT.curveSmooth == "12") { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().OctaveSmoothing = OctaveSmoothingType.Octave12; }
                    else if (DUT.curveSmooth == "24") { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().OctaveSmoothing = OctaveSmoothingType.Octave24; }

                    IGraphCollection Graphs = default(IGraphCollection);
                    Graphs = APx.ActiveMeasurement.Graphs;
                    IXYGraph XYGraph = default(IXYGraph);
                    ...
                    if (NoUpperRefCurve) { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().UpperLimit.ImportData(refCurve); }
                    else { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().UpperLimit.ImportData(refCurvePlus); }                
                    ...
                    else
                    {
                        ...
                        if (NoUpperRefCurve) { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().LowerLimit.ImportData(refCurve); }
                        else { APx.ActiveMeasurement.Graphs[3].Result.AsSmoothResult().LowerLimit.ImportData(refCurveMinus); }
            ...
            else if (sequenceID == "FreqSweep")
            {
                try
                {
                    ...
                    if (NoUpperRefCurve) { APx.SteppedFrequencySweep.Level.UpperLimit.ImportData(refCurve); }
                    else { APx.SteppedFrequencySweep.Level.UpperLimit.ImportData(refCurvePlus); }

                    if (NoUpperRefCurve) { APx.SteppedFrequencySweep.Level.LowerLimit.ImportData(refCurve); }
                    else { APx.SteppedFrequencySweep.Level.LowerLimit.ImportData(refCurveMinus); }
        ...
        {
            //Thread.Sleep(50);
            if (!testSelButton9.Checked) { APx.AcousticResponse.ClearData(); }

            try { APx.Sequence.Run(); }
            catch (Exception ex) { MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
            ...
            if (measurement.HasSequenceResults == true)
            {
                if (AUXCableSig == "Ring")
                {
                    if (MeasurementPassed()) { DUT.FRTestStatus2 = "PASSED"; }
                    else { DUT.FRTestStatus2 = "FAILED"; }
                }
                else
                {
                    if (MeasurementPassed())
                    {
                        if (testSelButton0.Checked) { DUT.FRTestStatus = DUT.PFForTest0Sel[0] = "PASSED"; }
                        else if ((testSelButton3.Checked) && ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W"))) { DUT.FRTestStatus = DUT.PFForTest3Sel[0] = "PASSED"; }
                        else { DUT.FRTestStatus = "PASSED"; }                        
                    }
                    else
                    {
                        if (testSelButton0.Checked){ DUT.FRTestStatus = DUT.PFForTest0Sel[0] = "FAILED"; }
                        else if ((testSelButton3.Checked) && ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W"))) { DUT.FRTestStatus = DUT.PFForTest3Sel[0] = "FAILED"; }
                        else { DUT.FRTestStatus = "FAILED"; }
                    }
                }

                //Get the sequence results
                ISequenceResultCollection Results = default(ISequenceResultCollection);
 ...
 //           remarkBox.Text = Folder.networkDrive + Folder.testDataFolder + FileName + DUT.FRTestStatus + ".xlsx";
  //          return;
        ...
        private void runMaxSPLTest(int ArrayIndex, Boolean SS400Mic, string FileName)
        {
            ...
            if (measurement.HasSequenceResults == true)
            {
                if (MeasurementPassed())
                {
                    ...
                    if ((testSelButton3.Checked) && ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W"))) { DUT.FRTestStatus = DUT.PFForTest3Sel[1] = "PASSED"; }
                    else if ((testSelButton0.Checked) || (testSelButton1.Checked) || (testSelButton2.Checked)) { DUT.PFForTest0Sel[1] = "PASSED"; }  //For log file

                }
                else
                {
                    DUT.SPLTestStatus = "FAILED";
                    if ((testSelButton3.Checked) && ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W"))) { DUT.FRTestStatus = DUT.PFForTest3Sel[1] = "FAILED"; }
                    else if ((testSelButton0.Checked) || (testSelButton1.Checked) || (testSelButton2.Checked)) { DUT.PFForTest0Sel[1] = "FAILED"; }  //For log file
                }
                //Get the sequence results
                ISequenceResultCollection Results = default(ISequenceResultCollection);
                Results = measurement.SequenceResults;
                ...
                try { SPLReading = Results[0].GetMeterValues(); } //FFT Spectrum -> Specify data point (xxx kHz) 
                catch (Exception ex) { MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        ...
        private void runNoiseTest(int ArrayIndex, string FileName)
        {
            ...
            if (measurement.HasSequenceResults == true)
            {
                if (MeasurementPassed()) { DUT.NoiseTestStatus = "PASSED"; }
                else { DUT.NoiseTestStatus = "FAILED"; }
                //Get the sequence results
                ISequenceResultCollection Results = default(ISequenceResultCollection);
                Results = measurement.SequenceResults;
        ...
        private void SaveData(String DetailFileName)
        {
            ...
            {
                if (DUT.SN[cnt] != "") { Serial_Numbers += DUT.SN[cnt] + ","; }
                if ((cnt == 5) && (DUT.productModel == "1000RX")) { Serial_Numbers += "NA,"; }
            }
            ...
            {
                if (DUT.driverSN[cnt1] != "") { Driver_SN += DUT.driverSN[cnt1] + ","; NoOfDriverCnt++; }
            }
           
            if ((DUT.SN[14] == "productButton18") && (NoOfDriverCnt == 5)) { Driver_SN += "NA,NA,NA,"; }

            if ((DUT.productModel == "360Xm 1-ST 25V-60W") || (DUT.productModel == "360Xm 1-ST 100V-60W") || (DUT.productModel == "360Xm 1-ST wo Trans")) { Driver_SN += "NA,NA,NA,"; }
            if ((DUT.productModel == "360Xm 2-ST 100V-120W") || (DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W") || (DUT.productModel == "360Xm 2-ST wo Trans")) { Driver_SN += "NA,NA,"; }

            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                  
            //P/F per test
            if (DUT.SN[14] == "productButton18") { Criteria_PassFail = DUT.PFForTest0Sel[0] + ","; }  //Only FR for LRAD-RX
            else { Criteria_PassFail = DUT.PFForTest0Sel[0] + "," + DUT.PFForTest0Sel[1] + ","; }   

            if (testSelButton1.Visible) { Criteria_PassFail += DUT.PFPerTestItem[1] + ","; }
            if (testSelButton2.Visible) { Criteria_PassFail += DUT.PFPerTestItem[2] + ","; }           

            if (DUT.productModel == "360Xm 2-ST wo Trans") { Criteria_PassFail += "NA,NA,"; }
            ...
            if (testSelButton3.Visible)            
            {
                ...
                else { Criteria_PassFail += DUT.PFPerTestItem[3] + ","; }
            }

            if (DUT.productModel == "360Xm 2-ST wo Trans") { Criteria_PassFail += "NA,NA,"; }

            if (testSelButton4.Visible) { Criteria_PassFail += DUT.PFPerTestItem[4] + ","; }  
            if (testSelButton5.Visible) { Criteria_PassFail += DUT.PFPerTestItem[5] + ","; }
            if (testSelButton6.Visible) { Criteria_PassFail += DUT.PFPerTestItem[6] + ","; }
            if (testSelButton7.Visible) { Criteria_PassFail += DUT.PFPerTestItem[7] + ","; }
            if (testSelButton8.Visible) { Criteria_PassFail += DUT.PFPerTestItem[8] + ","; }
            if (testSelButton9.Visible) { Criteria_PassFail += DUT.PFPerTestItem[9] + ","; }

            if (DUT.productModel == "950NXT") { Criteria_PassFail += "NA,"; }
            if (DUT.productModel == "360Xm 4-ST 100V-240W") { Criteria_PassFail += "NA,NA,NA,NA,NA,NA,"; }
            if ((DUT.SN[14] == "productButton4") && (AUXCableOption.Checked)) { Criteria_PassFail += "NA,"; }  //If 1000V but AUX cable is NOT included
            if ((DUT.productModel == "360Xm 1-ST 25V-60W") || (DUT.productModel == "360Xm 1-ST 100V-60W") || (DUT.productModel == "360Xm 2-ST 100V-120W")) { Criteria_PassFail += "NA,NA,NA,NA,"; }
                ...
                (DUT.SN[14] == "productButton16") || (DUT.SN[14] == "productButton10"))
            {
                ...
                {
                    if (DUT.productModel == "SS400") { dBSPL_Data = Math.Round(DUT.SPL[1], 1).ToString() + "," + Math.Round(DUT.SPL[0], 1).ToString() + ","; }
                    else { dBSPL_Data = Math.Round(DUT.SPL[0], 1).ToString() + ","; }
                }
                else
                {
            ...
            {
                if ((DUT.productModel == "360Xm 2-ST 25V-60W") || (DUT.productModel == "360Xm 2-ST 70V-60W")) { dBSPL_Data = Math.Round(DUT.SPL[0], 1).ToString() + "," + Math.Round(DUT.SPL[3], 1).ToString() + ","; }
                else { dBSPL_Data = Math.Round(DUT.SPL[0], 1).ToString() + ",NA,"; }
            }
            else
            {
        ...
        {
            if (AUXCableOption.Checked) { testSelButton9.Visible = false; testResult9.Visible = false; }
            else { testSelButton9.Visible = true; testResult9.Visible = true; }
        }
